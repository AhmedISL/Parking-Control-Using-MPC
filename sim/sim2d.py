...
def sim_run(options, MPC):
    ...
    for i in range(1,sim_total+1):
        ...
        if (i > 84 and ref_2 != None):
            ref = ref_2
        if (i > 167 and ref_3 != None):
            ref = ref_3
